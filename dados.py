...
BANCO_CONVERSAS = {
    ...
    "lakers_tecnico": {
        "resposta": "O técnico atual do Lakers é o JJ Redick, ele trabalha com o elenco para manter o nível alto. O time tem um padrão de excelência que vem desde os primeiros dias da franquia!",
